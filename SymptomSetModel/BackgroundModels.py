...
class vLPIBackground:
	...
	def ComputeSurprisal(self,DxArray,SymptomColumns,numParticles=50):
		...
		assert len(set(SymptomColumns).symmetric_difference(self.local_clinical_dataset.dxCodeToDataIndexMap.keys()))==0,"Data array and vLPIBackground model must contain identical symptoms."
